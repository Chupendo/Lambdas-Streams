...
public class PersonDigitalCenters {
	...
	public PersonDigitalCenters(Integer codEmployed, String name, String linkCV, String technologyComunity, Double rate,
			...
			String admisionDate, String outputPreviewDate, String validaterMain, String validaterSecond,
			String assigned, String subcontracted) {
	...
	public int hashCode() {
		return Objects.hash(admisionDate, assigned, center, codEmployed, drefyfusLevel, linkCV, name, office,
				outputPreviewDate, profile, rate, rol, scholar, subcontracted, technologyComunity, validaterMain,
				validaterSecond);
	}
	...
	public String toString() {
		return "PersonDigitalCenters [codEmployed=" + codEmployed + ", name=" + name + ", linkCV=" + linkCV
				...
				+ ", scholar=" + scholar + ", admisionDate=" + admisionDate + ", outputPreviewDate=" + outputPreviewDate
				+ ", validaterMain=" + validaterMain + ", validaterSecond=" + validaterSecond + ", assigned=" + assigned
