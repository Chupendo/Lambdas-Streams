package lambadas.secction.three.consumer.ejercicios.three;
...
public class Ejercicio1 {
	...
	public static void main(String[] args) {
		...
		//Combiancion de dons consumer: 1º Incrmenta, luego imprime
		System.out.println("Concatenacion de consumer 'andThen' ");
		Consumer<Estudiante> cons3 = cons2.andThen(cons1);
		op.aceptarTodos(cons3, lestudiantes);
	}
}
