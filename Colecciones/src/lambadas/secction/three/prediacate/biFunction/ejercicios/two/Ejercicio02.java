package lambadas.secction.three.prediacate.biFunction.ejercicios.two;
...
public class Ejercicio02 {
	...
	public static void main(String[] args) {
		...
		List<Empleado> lEmpladosMenores25 = evaNot.evaluadornNot(listaEmpleados, (empleado)->empleado.getEdad()>25);
		lEmpladosMenores25.forEach(System.out::println);
		//2º Aplicmaos el incremento
		System.out.println("Incrementa el salario a los menores de 25 un 2%");
		for(Empleado empleado:lEmpladosMayores25) {
			Double nuevoSalario = func.incrementoSalario(empleado, 5.00, (sal,inc)-> sal+(sal*inc/100));
			empleado.setSalario(nuevoSalario);
		}
